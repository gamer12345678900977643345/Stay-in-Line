...
def show(screen, clock, score: int, highscore: int) -> str:
    """
    Toont het eindscherm.
    Geeft 'restart' of 'quit' terug.
    """

    font_title  = pygame.font.SysFont(None, 72)
    font_score  = pygame.font.SysFont(None, 52)
    ...
    while running:
        ...
        screen.blit(end_screen, end_screen.get_rect(centerx=cx, centery=int(screen_h * 0.50)))
        ...
        # ---- HIGHSCORE ----
        if is_new_record:
            hs_surf = font_sub.render("🏆  New record!", True, (255, 220, 0))
        else:
